...
class TreatmentSlidingImages extends StatefulWidget {
  const TreatmentSlidingImages({super.key});

  @override
  State<TreatmentSlidingImages> createState() => _TreatmentSlidingImagesState();
}

class _TreatmentSlidingImagesState extends State<TreatmentSlidingImages> {
